...
% Last Modified by GUIDE v2.5 20-Feb-2014 12:51:05
...
function getDataUART(s)
 ...
 % uint8_t UART_Header[5] = {0x55,0xaa}; // ky tu dac biet
 while (synIndex < (lenFrameData - 3))
     if ((data(synIndex)==85)&&(data(synIndex+1)==170))
 ...
 yDataCH1(end-lenData+1:end) = nDataCH1*3.3/4096;
 ...
 axis(handles.axes1,[xmax-200 xmax 0 5]);
