...
#define sampling_time           system_clock/10^(-3)                         // everty 10 ms
#define inv_sampling_time       1/sampling_time
//
//double pPart, dPart, iPart;
//double Err, pre_Err;
//double Output;
//double kd, ki, kp;
...
{   
      ...
      pulse_speed=(rpm_control/0.3);            //Hz - số xung cho một vòng
...
{
    Err=int(rpm_default-encoderSpeed);                // error calculating
     // PID parts
    pPart=Kp*Err;
    dPart=Kd*(Err-pre_Err)*inv_sampling_time;       
